...
onto it, exactly like [`programs/p2p-share/`](../p2p-share/) does for file transfers, just
...
```bash
cd pc && ./start.sh
# Tab A: http://127.0.0.1:8080/programs/video-broadcast/client/?name=Alice&room=test
# Tab B: http://127.0.0.1:8080/programs/video-broadcast/client/?name=Bob&room=test
```
